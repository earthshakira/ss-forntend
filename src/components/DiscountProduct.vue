<template>
  <div class="row">
    ...
    <div class="col-sm-9 text-left" style="padding-top:1em">
      ...
      <p v-if="totalPrice == newPriceAmount" class="totalPrice" style="position:absolute;right:1em;top:4.7em;"><b>{{ totalPrice }}.00</b></p>
      <p v-else class="totalPrice" style="position:absolute;right:1em;top:4.7em;"><b><strike>{{ totalPrice }}.00</strike> &nbsp;&nbsp; {{newPriceAmount}}.00</b></p>
    </div>
  </div>
</template>
